...
public class Robot{
	...
	private Background bg4 = Level2.getBg4();
	...
	public void Check_Collision() {
		...
		if (Rect.intersects(rect4, GameScreen.c1.r1)) {
			GameScreen.c1.setCenterX(-100);
			GameScreen.score += 20;
		}
		if (Rect.intersects(rect4, GameScreen.c2.r1)) {

			GameScreen.c2.setCenterX(-100);
			GameScreen.score += 20;

		}
		if (Rect.intersects(rect4, GameScreen.c3.r1)) {
			GameScreen.c3.setCenterX(-100);
			GameScreen.score += 20;

		}
		if (Rect.intersects(rect4, GameScreen.c4.r1)) {
			GameScreen.c4.setCenterX(-100);
			GameScreen.score += 20;
		}
		if (Rect.intersects(rect4, GameScreen.c5.r1)) {
			GameScreen.c5.setCenterX(-100);
			GameScreen.score += 20;
		}
		if (Rect.intersects(rect4, GameScreen.c6.r1)) {
			GameScreen.c6.setCenterX(-100);
			GameScreen.score += 20;
			done = true;
		}
	}
